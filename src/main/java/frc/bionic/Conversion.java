...
public class Conversion {
     ...
     *
     * @param revers              Number of revolutions traveled
     *
     * @param wheelDiameterMeters The diameter of the wheel
     *
     * @return Equivalent number of meters traveled
     */
     ...
     *
     * @param meters              Number of meters traveled
     *
     * @param wheelDiameterMeters The diameter of the wheel
     *
     * @return Equivalent number of revolutions traveled
     */
     ...
     *
     * @param rpm                 Revolutions per minute to convert
     *
     * @param wheelDiameterMeters The diameter of the wheel
     *
     * @return Revolutions per minute converted into meters per second
     */
     ...
     *
     * @param meters              Meters per second to convert
     *
     * @param wheelDiameterMeters The diameter of the wheel
     *
     * @return Meters per second converted into revolutions per minute
     */
     ...
     *
     * @param ticksPerRev Number of ticks per one full revolution of the encoder
     *
     * @return Degrees of motion resulting from specified number of ticks
     */
     ...
     * @param ticksPerRev Number of ticks per one full revolution of the encoder
     *
     * @return Ticks resulting from specified degrees of motion
     */
    ...
    /**
     * Convert degrees to radians, first scaling degrees to to the range [ 0.0,
     * 360.0 ].
     *
    ...
    /**
     * Convert radians to degrees, first scaling radians to the range [ 0.0, 2 * PI
     * ].
     *
    ...
    /**
     * Normalize a value to be within a range https://stackoverflow.com/a/2021986
     *
